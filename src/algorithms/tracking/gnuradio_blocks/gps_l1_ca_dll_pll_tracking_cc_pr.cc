...
#include "gps_l1_ca_dll_pll_tracking_cc_pr.h"
#include <cmath>
#include <iostream>
#include <complex>
#include <memory>
...
{
    return gps_l1_ca_dll_pll_tracking_cc_pr_sptr(new Gps_L1_Ca_Dll_Pll_Tracking_cc_pr(if_freq,
            fs_in, vector_length, dump, dump_filename, pll_bw_hz, dll_bw_hz, early_late_space_chips));
}



void Gps_L1_Ca_Dll_Pll_Tracking_cc_pr::forecast (int noutput_items,
...
Gps_L1_Ca_Dll_Pll_Tracking_cc_pr::Gps_L1_Ca_Dll_Pll_Tracking_cc_pr(
        long if_freq,
        long fs_in,
        unsigned int vector_length,
        bool dump,
        ...
        gr::block("Gps_L1_Ca_Dll_Pll_Tracking_cc_pr", gr::io_signature::make(1, 1, sizeof(gr_complex)),
		  gr::io_signature::make2(2, 2, sizeof(Gnss_Synchro),sizeof(gr_complex))),rec_kernel(vector_length)
{
...
void Gps_L1_Ca_Dll_Pll_Tracking_cc_pr::start_tracking()
{
    /*
    ...
    if (current_synchro_data.Flag_valid_symbol_output == false)
     {
       ...
       produce (1,d_current_prn_length_samples);
...
void Gps_L1_Ca_Dll_Pll_Tracking_cc_pr::set_channel(unsigned int channel)
{
    d_channel = channel;
...
void Gps_L1_Ca_Dll_Pll_Tracking_cc_pr::set_gnss_synchro(Gnss_Synchro* p_gnss_synchro)
{
