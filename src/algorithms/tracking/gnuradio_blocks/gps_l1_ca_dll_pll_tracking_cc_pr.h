...
#ifndef GNSS_SDR_GPS_L1_CA_DLL_PLL_TRACKING_CC_PR_H
#define GNSS_SDR_GPS_L1_CA_DLL_PLL_TRACKING_CC_PR_H
...
class Gps_L1_Ca_Dll_Pll_Tracking_cc_pr;

typedef boost::shared_ptr<Gps_L1_Ca_Dll_Pll_Tracking_cc_pr>
 ...
 */
class Gps_L1_Ca_Dll_Pll_Tracking_cc_pr: public gr::block
{
public:
    ~Gps_L1_Ca_Dll_Pll_Tracking_cc_pr();
...
#endif //GNSS_SDR_GPS_L1_CA_DLL_PLL_TRACKING_CC_PR_H
